...
{
    public class FriendlyHallowBossSplitShotCore : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            AIType = ProjectileID.HallowBossSplitShotCore;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            float maxScale = Projectile.scale - 0.5f;
            float scaleDiv = 20f;
        ...
        public int endCounter = 5;
        public int cooldown = 0;
        public float rot = -0.5f;
        public Vector2 vel1 = new(0, -5);
        public Vector2 vel2 = new(5, 5);
        public Vector2 vel3 = new(-5, 5);

        public override void AI()
        {
            cooldown--;
            if (Projectile.timeLeft <= 150 && counter < endCounter && cooldown <= 0) {
                Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.Center, vel1, ModContent.ProjectileType<FriendlyHallowBossSplitShot>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
                Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.Center, vel2, ModContent.ProjectileType<FriendlyHallowBossSplitShot>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
                Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Projectile.Center, vel3, ModContent.ProjectileType<FriendlyHallowBossSplitShot>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
                if (Projectile.ai[1] == 1) rot = 0.5f;
                vel1 = vel1.RotatedBy(rot);
                vel2 = vel2.RotatedBy(rot);
                vel3 = vel3.RotatedBy(rot);
                counter++;
                cooldown = 10;
            }
        }
